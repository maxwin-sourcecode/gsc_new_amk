      ...
      <div class="row">
        <div class="col-md-6 offset-md-3">
          <div class="p-3 shadow bg-transparent border border-1 border-light rounded-4">
            ...
            <h5 class="text-center mt-3 text-white">Agent Login</h5>
            ...
            <form action="{{ route('login') }}" method="post" class="p-5">
              ...
              <div class="mb-3">
                ...
                <input type="text" name="user_name" id="login" class="form-control" placeholder="Enter your user name " value="{{ $agent->user_name }}">
                @error('phone')
