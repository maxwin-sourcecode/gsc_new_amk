                    ...
                    <div class="card-body">
                        <form role="form" method="POST" class="text-start" action="{{ route('admin.bank.update', $bank->id) }}">
                            ...
                            <div class="custom-form-group">
                                ...
                                <select name="payment_type_id" id="">
                                    ...
                                    @foreach($paymentTypes as $paymentType)
                                        <option value="{{$paymentType->id}}" {{$paymentType->id == $bank->payment_type_id ? 'selected': ''}}>{{$paymentType->name}}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="custom-form-group">
                                ...
                                <input type="text"  name="account_name" class="form-control" value="{{ $bank->account_name }}" placeholder="Enter Bank Account Name">
                                @error('account_name')
                                <span class="text-danger d-block">*{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="custom-form-group">
                                ...
                                <input type="text"  name="account_number" class="form-control" value="{{$bank->account_number}}" placeholder="Enter Bank Account Number">
